...
TEXTS: dict[str, dict[str, str]] = {
    ...
    "nav_register": {"ru": "Регистрация на конференцию", "en": "Conference registration"},
    ...
    "conference_page_title": {"ru": "Регистрация на конференцию", "en": "Conference registration"},
    "conference_title": {"ru": "Регистрация на конференцию", "en": "Conference registration"},
    "conference_desc": {
...
FIELD_LABELS: dict[str, dict[str, str]] = {
    ...
    "last_name": {"ru": "Фамилия", "en": "Last name"},
    "first_name": {"ru": "Имя", "en": "First name"},
    "middle_name": {"ru": "Отчество", "en": "Middle name"},
    "place_of_study": {"ru": "Место учёбы", "en": "Place of study"},
    "department": {"ru": "Кафедра", "en": "Department"},
    "place_of_work": {"ru": "Место работы", "en": "Place of work"},
    "job_title": {"ru": "Должность", "en": "Job title"},
    "phone": {"ru": "Телефон", "en": "Phone"},
    "email": {"ru": "Контактный email", "en": "Contact email"},
    "participation": {"ru": "Участие", "en": "Participation"},
    "section": {"ru": "Секция", "en": "Section"},
    "publication_title": {"ru": "Название публикации", "en": "Publication title"},
    "foreign_language_consultant": {
        "ru": "ФИО Консультанта по иностранному языку",
        "en": "Foreign language consultant full name",
    },
    ...
    "expert_opinion_file": {"ru": "Экспертное заключение", "en": "Expert opinion"},
    "expert_opinion_file.filename": {"ru": "Экспертное заключение: имя", "en": "Expert opinion: name"},
    "expert_opinion_file.content_type": {"ru": "Экспертное заключение: тип", "en": "Expert opinion: type"},
    "expert_opinion_file.size_bytes": {"ru": "Экспертное заключение: размер", "en": "Expert opinion: size"},
...
SECTION_LABELS = {
    SECTION_OPTIONS[0]: {"ru": SECTION_OPTIONS[0], "en": "Electronics and laser engineering"},
    ...
    SECTION_OPTIONS[5]: {"ru": SECTION_OPTIONS[5], "en": "Robotics and integrated automation"},
    SECTION_OPTIONS[6]: {"ru": SECTION_OPTIONS[6], "en": "Computer science and IT"},
